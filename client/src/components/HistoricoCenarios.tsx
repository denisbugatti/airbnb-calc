...
import { History, X, Trash2, RotateCcw, ChevronDown, ChevronUp, BookmarkPlus } from "lucide-react";
...
export default function HistoricoCenarios({ onRestaurar }: Props) {
  const { cenarios, removerCenario, limparHistorico } = useCenarios();
                        ...
                        <div className="px-4 pt-4 pb-3">
                          <div className="flex items-start justify-between gap-2 mb-3">
                            ...
                            <div className="flex items-center gap-1.5 shrink-0">
                              <button
                                onClick={() => { onRestaurar(c); setOpen(false); }}
