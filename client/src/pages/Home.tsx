        ...
        <div className="md:grid md:grid-cols-[380px_1fr] md:gap-5">
          ...
          <div className={`space-y-3 ${activeTab === "inputs" ? "hidden md:block" : ""}`}>
            ...
            {(() => {
              ...
              // SVG layout
              const svgW = 980; const svgH = 600;
              const padL = 70; const padR = 140; const padTop = 60; const padBot = 150;
                ...
                <GlassPanel delay={0.35} colors={colors}>
                  ...
                  <div className="w-full overflow-x-auto">
                    ...
                    >
                      ...
                      {/* Label RECEITA BRUTA — posicionado junto à linha verde no ano 1 */}
                      <text x={padL} y={yOf(chartData[0].receita) - 18} fill={textC} fontSize={20} fontWeight="900" fontFamily="'Geist', sans-serif" letterSpacing="2">RECEITA BRUTA</text>
                      {/* Eixo X */}
